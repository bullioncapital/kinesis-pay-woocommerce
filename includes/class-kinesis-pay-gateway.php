...
class Kinesis_Pay_Gateway extends WC_Payment_Gateway
{
  ...
  public function __construct()
  {
    ...
    // $this->icon = apply_filters('woocommerce_kinesis_pay_icon', plugins_url('../assets/images/logo.svg', __FILE__));
  ...
  public function init_form_fields()
  {
    $this->form_fields = array(
      ...
      'test_frontend_base_url' => array(
        'title' => 'Test frontend base URL',
        'type' => 'text',
        'description' => 'This URL will be only used when Test mode is enabled. If the value is empty, https://qa1-kms.kinesis.money will be used by default.',
      ),
      'test_backend_base_url' => array(
        'title' => 'Test backend base URL',
        'type' => 'text',
        'description' => 'This URL will be only used when Test mode is enabled. If the value is empty, https://qa1-api.kinesis.money will be used by default.',
      ),
      'merchant_id' => array(
